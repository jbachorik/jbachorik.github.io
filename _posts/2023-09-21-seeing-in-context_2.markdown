...
{% highlight java %}
@Name("tracer-context") // the context type nae
...
public clas TracerContextType extends ContextType {
  ...
  public TracerContextType set(String traceid, String spanid) {
...
I would love to hear some feedback on this proposal - you can reach me on X where my handle is `@yardus`.
